...
const mapDispatchToProps = dispatch => ({
    ...
    textChangerSetValueAction: (innerText, placeholder, elementId, rootPage, buttonText) =>
        dispatch(textChangerSetValue(innerText, placeholder, elementId, rootPage, buttonText)),
    createNewElemAction: elemName => dispatch(createNewElem(elemName)),
    changeElemNameAction: (newName, id) => dispatch(changeElemName(newName, id)),
    deleteElemAction: id => dispatch(deleteElem(id)),
    changeTaskTextAction: (id, newText) => dispatch(changeTaskText(id, newText)),
