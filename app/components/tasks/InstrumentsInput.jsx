...
export class InstrumentsInput extends Component {
    ...
    render() {
        return (
            <div className="input">
                <button onClick={this.backToTaskList}>{"<<"}</button>
                <input type="text" ref={this.inputRef} placeholder="Что нужно сделать?" />
                <button onClick={this.addNewTask}>Добавить</button>
            </div>
        );
    }
}
